...
public class PracticoExperto {
    ...
    public Cliente obtenerClienteQueGastoMasEnProducto(@RequestParam int posProducto) {
        ...
        return SistemaClientes.getInstancia().obtenerClienteQueGastoMasEnProducto(p);
    }
    ...
    public List<Cliente> obtenerClientesQueGastaronMasQueEnXProducto(@RequestParam int monto,
